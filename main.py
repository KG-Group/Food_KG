...
DNode = matcher.match("Disease",name = "动脉硬化").first()
FNode = matcher.match("Nutrition",name = "脂肪（g）").first()
Edge = Relationship(DNode,"低",FNode)
graph.create(Edge)
graph.push(Edge)

DNode = matcher.match("Disease",name = "动脉硬化").first()
FNode = matcher.match("Nutrition",name = "蛋白质（g）").first()
Edge = Relationship(DNode,"高",FNode)
graph.create(Edge)
graph.push(Edge)

DNode = matcher.match("Disease",name = "冠心病").first()
FNode = matcher.match("Nutrition",name = "脂肪（g）").first()
Edge = Relationship(DNode,"低",FNode)
graph.create(Edge)
graph.push(Edge)
...
DNode = matcher.match("Disease",name = "冠心病").first()
FNode = matcher.match("Nutrition",name = "CHO（g）").first()
Edge = Relationship(DNode,"低",FNode)
graph.create(Edge)
graph.push(Edge)

DNode = matcher.match("Disease",name = "糖尿病和高血压").first()
FNode = matcher.match("Nutrition",name = "CHO（g）").first()
Edge = Relationship(DNode,"低",FNode)
graph.create(Edge)
graph.push(Edge)
...
DNode = matcher.match("Disease",name = "糖尿病和高血压").first()
FNode = matcher.match("Nutrition",name = "胆固醇（mg）").first()
Edge = Relationship(DNode,"低",FNode)
graph.create(Edge)
graph.push(Edge)
...
DNode = matcher.match("Disease",name = "高血脂").first()
FNode = matcher.match("Nutrition",name = "脂肪（g）").first()
Edge = Relationship(DNode,"低",FNode)
graph.create(Edge)
graph.push(Edge)
...
DNode = matcher.match("Disease",name = "高血压").first()
FNode = matcher.match("Nutrition",name = "CHO（g）").first()
Edge = Relationship(DNode,"低",FNode)
graph.create(Edge)
graph.push(Edge)
...
DNode = matcher.match("Disease",name = "糖尿病").first()
FNode = matcher.match("Nutrition",name = "CHO（g）").first()
Edge = Relationship(DNode,"低",FNode)
graph.create(Edge)
graph.push(Edge)
...
DNode = matcher.match("Disease",name = "肥胖症").first()
FNode = matcher.match("Nutrition",name = "脂肪（g）").first()
Edge = Relationship(DNode,"低",FNode)
graph.create(Edge)
graph.push(Edge)
